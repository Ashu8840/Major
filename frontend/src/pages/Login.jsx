...
import { IoEye, IoEyeOff, IoMail, IoLockClosed, IoSparkles, IoCheckmarkCircle, IoWarning } from 'react-icons/io5';
          ...
          <div className="space-y-6 text-left">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-blue-200 text-sm">Get intelligent suggestions and insights</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-blue-200 text-sm">Your stories are safe and encrypted</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-blue-200 text-sm">Connect with fellow storytellers</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="w-full max-w-md">
          <div className="bg-white/95 backdrop-blur-sm rounded-3xl shadow-2xl p-8 border border-white/20">
            <div className="text-center mb-8">
              ...
              <p className="text-blue-600">Welcome back to your creative space</p>
            </div>
